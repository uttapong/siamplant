    ...
    */
    ...
    'templates' => array(
        ...
        'profile' =>function($image){
            //return $image->fit(180,180);
            return $image->fit(60, null, function ($constraint) {
                $constraint->aspectRatio();
            });
        },
        'profilepreview' =>function($image){
            //return $image->fit(180,180);
            return $image->fit(90, null, function ($constraint) {
                $constraint->aspectRatio();
            });
        },
        'shopicon' =>function($image){
            //return $image->fit(180,180);
            return $image->fit(350, null, function ($constraint) {
                $constraint->aspectRatio();
            });
        }
